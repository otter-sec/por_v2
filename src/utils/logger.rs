...
impl ProveProgress {
    ...
    fn update_total_progress(&mut self) {
        self.total_progress = (self.done_batch_circuits as f64 / self.total_batch_circuits as f64)
            * BATCH_PROVE_PROGRESS;
        self.total_progress += (self.done_recursive_proofs as f64
            / self.total_recursive_proofs as f64)
            * RECURSIVE_PROVE_PROGRESS;
        self.total_progress += (self.created_recursive_circuits as f64
            / self.total_recursive_circuits as f64)
            * RECURSIVE_CIRCUIT_PROGRESS;
    }
...
pub fn print_header() {
    println!("========================================================================");
    println!(
        r"   ____  _   _            _____             _____      _____       ___
  / __ \| | | |          / ____|           |  __ \    |  __ \     |__ \
